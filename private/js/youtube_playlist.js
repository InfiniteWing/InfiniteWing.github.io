$(function () {
	var videos = [
		{videoURL: "-P3squTEJ4M",containment:'self',autoPlay:false, startAt:0,opacity:1, loop:true, stopMovieOnBlur: false, remember_last_time: true},
		{videoURL:"HQnC1UHBvWA",containment:'self',autoPlay:false, startAt:0,opacity:1, loop:true, stopMovieOnBlur: false, remember_last_time: true},
		{videoURL: "VcQIpQB4Fiw",containment:'self',autoPlay:false, startAt:0,opacity:1, loop:true, stopMovieOnBlur: false, remember_last_time: true}
	];
